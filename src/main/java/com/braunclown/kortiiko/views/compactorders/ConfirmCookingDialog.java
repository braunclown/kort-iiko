...
public class ConfirmCookingDialog extends Dialog {
    ...
    private Component createLayout() {
        ...
        amountField = new TextField("Количество");
    ...
    private Component createKeyboard() {
        ...
        keyboard.add(
                ...
                createNumberButton(0), createDotButton(), createBackspaceButton()
        );
        return keyboard;
    }
    ...
    private Component createNumberButton(int number) {
        ...
        key.addThemeVariants(ButtonVariant.LUMO_PRIMARY);
    ...
    private Component createDotButton() {
        ...
        dotButton.addThemeVariants(ButtonVariant.LUMO_PRIMARY);
    ...
    private Component createBackspaceButton() {
        ...
        backspace.addThemeVariants(ButtonVariant.LUMO_PRIMARY);
